...
void SCVars::InitCVars(IConsole *pConsole)
{
  ...
  pConsole->Register("cl_frozenKeyMult", &cl_frozenKeyMult, 0.02f, VF_CHEAT, "Frozen movement keys multiplier");
	...
	pConsole->Register("g_playerSuitEnergyRechargeTime", &g_playerSuitEnergyRechargeTime, 4.0f, VF_CHEAT, "Modify suit energy recharge for Player.");
	...
	pConsole->Register("g_playerSuitArmorModeHealthRegenTimeMoving", &g_playerSuitArmorModeHealthRegenTimeMoving, 25.0f, VF_CHEAT, "Modify suit health recharge for Player moving in armor mode.");
