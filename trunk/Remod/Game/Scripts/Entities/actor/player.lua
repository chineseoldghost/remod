...
Player = {
   ...
   -- Damage multipliers for physics, vehicle and MP vehicle collisions with the player. Not sure what value it multiplies.
	...
	{	
		...
		fileModel = "objects/characters/human/us/marine/marine_05_helmet_goggles_on.cdf", -- Third person player model.
		clientFileModel = "objects/characters/human/us/marine/marine_05_helmet_goggles_on.cdf", -- First person legs?
